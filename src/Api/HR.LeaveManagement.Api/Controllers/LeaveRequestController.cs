...
namespace HR.LeaveManagement.Api.Controllers
{
    ...
    public class LeaveRequestController : ControllerBase
    {
        ...
        // PUT: api/LeaveRequest/changeapproval     - changes to "approved"-status
        [HttpPut("changeapproval/{id}")]
        public async Task<ActionResult> CangeApproval(int id, [FromBody] ChangeLeaveRequestApprovalDto approvedRequest)
        {
